...
```
cd existing_repo
git remote add origin https://gitlab.cs.washington.edu/cse443-wi26-projects/chronica11y.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.cs.washington.edu/cse443-wi26-projects/chronica11y/-/settings/integrations)
